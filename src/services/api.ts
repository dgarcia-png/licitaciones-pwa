// src/services/api.ts — ACTUALIZADO 1/04/2026
// [1/04] informeRendimiento + mapaOperarios añadidos
...
export const api = {
  ...
  batchPlanificacion:       (semana?: string) => fetchAPI('batch_planificacion', semana ? { semana } : {}),
